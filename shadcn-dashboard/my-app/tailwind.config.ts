	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				sidebar: 'hsl(276, 6.2%, 15.9%)',
				"sidebar-foreground": 'hsl(274, 14.3%, 90.4%)',
				"sidebar-primary": 'hsl(212, 93.3%, 53.3%)',
				"sidebar-primary-foreground": 'hsl(0, 0%, 0%)',
				"sidebar-accent": 'hsl(276, 6.2%, 15.9%)',
				"sidebar-accent-foreground": 'hsl(274, 14.3%, 90.4%)',
				"sidebar-border": 'hsl(276, 6.2%, 15.9%)',
				"sidebar-ring": 'hsl(212, 93.3%, 53.3%)',

				// Standard shadcn/ui semantic colors
				border: 'hsl(276, 6.2%, 15.9%)',
				input: 'hsl(274, 5.3%, 25.7%)',
				ring: 'hsl(212, 93.3%, 53.3%)',
				background: 'hsl(270, 18.2%, 4.3%)',
				foreground: 'hsl(274, 14.3%, 90.4%)',
				destructive: {
					DEFAULT: 'hsl(0, 62.8%, 30.6%)',
					foreground: 'hsl(0, 0%, 98%)',
				},
				muted: {
					DEFAULT: 'hsl(276, 6.2%, 15.9%)',
					foreground: 'hsl(278, 9.8%, 83.9%)',
				},
				accent: {
					DEFAULT: 'hsl(276, 6.2%, 15.9%)',
					foreground: 'hsl(274, 14.3%, 90.4%)',
